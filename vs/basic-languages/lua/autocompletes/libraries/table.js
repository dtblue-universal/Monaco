define(["require", "exports"], function (require, exports) {
	...
	exports.autocompletes = {
		...
		Function: {
			...
			'isfrozen()': {
				insertText: 'isfrozen(${1:list})',
				sortText: 'isfrozen',
				documentation: {
					value: [
						'```lua', 'function isfrozen(list: table): boolean', '```'
					].join('\n')
				},
			},

			'clone()': {
				insertText: 'clone(${1:list})',
				sortText: 'clone',
				documentation: {
					value: [
						'```lua', 'function clone(list: table): table', '```'
					].join('\n')
				},
			},

			'clone()': {
				insertText: 'freeze(${1:list})',
				sortText: 'freeze',
				documentation: {
					value: [
						'```lua', 'function freeze(list: table): table', '```'
					].join('\n')
				},
			},

			'maxn()': {
				insertText: 'maxn(${1:list})',
				sortText: 'maxn',
				documentation: {
					value: [
						'```lua', 'function maxn(list: table): number', '```'
					].join('\n')
				},
			},
		},
