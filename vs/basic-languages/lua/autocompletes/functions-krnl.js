define(["require", "exports"], function (require, exports) {
	...
	exports.autocompletes = {
		"Function": {
			...
			"hookfunc()": {
				"insertText": "hookfunc(${1:f}, ${2:hook})",
				"documentation": {
					value: [
						"```lua", "function hookfunc(f: function, hook: function))\n  -> original: function", "```",
						"",
						"Redirects calls to `f` with `hook` and returns the original function.",
					].join("\n")
				},
			...
			"hookmetamethod()": {
				"insertText": "hookmetamethod(${1:object}, ${2:metamethod}, newcclosure(function(...)\n\t\nend))",
			},
			...
			"http_request()": {
				"insertText": "http_request(${1:data})",
				"documentation": {
					value: [
						"```lua", "function http_request(requestOptions: RequestOptions)\n  -> Response", "```",
						"",
						"Sends an HTTP request using a dictionary to specify the request data, such as the target URL, method, headers and request body data. It returns a dictionary that describes the response data received.",
						'',
						'```lua',
			...
			"getfflag()": {
				...
				"documentation": {
					value: [
						...
						"",
						"Gets the value of a specified fflag.",
					].join("\n")
				},
			},

			"firesignal()": {
				"insertText": "firesignal(${1:Signal}, [...args])"
			},
			...
			// cba to label
			"clonefunc()": {
				"insertText": "clonefunc(${1:func})",
				"documentation": {
					value: [
						"```lua",
						"local cloned_function = clonefunc(newcclosure)",
						"```"
					]
				}
			},
			...
			"getscripthash()": {
				"insertText": "getscripthash(${1:LocalScript|ModuleScript})",
				"documentation": [
					"```lua",
			...
			"getscriptbytecode()": {
				"insertText": "getscriptbytecode(${1:LocalScript|ModuleScript})",
				"documentation": [
					'```lua',
			...
			"getcallbackvalue": {
				"insertText": "getcallbackvalue(${1:Instance}, ${2:SignalName})"
			},

			"getcallbackmember": {
				"insertText": "getcallbackmember(${1:Instance}, ${2:SignalName})"
			},

			"saveinstance": {
				"insertText": [
					'saveinstance(game, `{game.PlaceId}.rbxl`, {',
					'\tDecompile = false,',
					'\tDecompileTimeout = 10,',
			...
			"lz4compress": {
				"insertText": "lz4compress(${1:string})"
			},

			"lz4decompress": {
				"insertText": "lz4decompress(${1:string})"
			}
		},
