define(["require", "exports"], function (require, exports) {
	...
	exports.autocompletes = {
		...
		Method: {
			...
			'Once()': {
				insertText: 'Once(${1:func})',
				sortText: 'Once',
				documentation: {
					value: [
						'```lua', 'function Once(func: (...any) -> nil)\n  -> RBXScriptConnection', '```',
						'',
						'Establishes a function to be called once whenever the event is raised. Returns a [`RBXScriptConnection`](https://developer.roblox.com/en-us/api-reference/datatype/RBXScriptConnection) object associated with the connection.',
						'',
						'```lua',
						'export type RBXScriptConnection = {',
						'\tConnected: bool,',
